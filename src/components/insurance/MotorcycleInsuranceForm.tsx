// src/components/insurance/MotorcycleInsuranceForm.tsx
// Formulario para cotizar seguro de moto utilizando Formik y validación con Yup

import React, { useState } from "react";
import { Formik, Form, Field } from "formik";
import FormField from "../form/FormField";
import { motorcycleInsuranceSchema } from "../../validation/schemas";
...
import { motorcycleInsurancePlans } from "../../data/insurancePlans";
...
const MotorcycleInsuranceForm: React.FC<MotorcycleInsuranceFormProps> = ({
	onCancel,
	onShowHistory,
}) => {
	...
	const handleSubmit = async (
		...
		try {
			// Calcular cotización
			const result = calculationService.calculateMotorcycleInsurance(values);
			...
			console.log("Cotización de moto guardada con ID:", storedQuote.id);
			...
			if (alertResult.isConfirmed) {
				await showSuccessAlert(
					"Cotización guardada",
					"Tu cotización de moto se ha guardado en el historial."
				);
			}
		} catch (error) {
			await showErrorAlert(
				"Error",
				"No pudimos calcular tu cotización de moto. Por favor, intenta nuevamente."
			);
		} finally {
			setSubmitting(false);
		}
	...
	const motorcycleCCOptions = [
		{ value: "50", label: "Hasta 50cc" },
		{ value: "150", label: "51-150cc" },
		{ value: "300", label: "151-300cc" },
		{ value: "600", label: "301-600cc" },
		{ value: "1000", label: "601-1000cc" },
		{ value: "1001", label: "Más de 1000cc" },
	];

	const getSelectedPlanDetails = (coveragePlan: string) => {
		const plan = motorcycleInsurancePlans.find((p) => p.value === coveragePlan);
		if (!plan) return null;
	...
	return (
		<div className="motorcycle-insurance-form">
			...
			<div className="d-flex justify-content-between align-items-center mb-4">
				<div className="d-flex align-items-center">
					...
					<h2 className="mb-0">Cotizar Seguro de Moto</h2>
				</div>
				<button
					type="button"
			...
			<Formik
				...
				validationSchema={motorcycleInsuranceSchema}
				...
				{({ isSubmitting, values, errors }) => (
					<Form>
						...
						<div className="card mb-4">
							<div className="card-header bg-light">
								<h5 className="mb-0">Información de la Motocicleta</h5>
							</div>
							<div className="card-body">
								<div className="row">
									<div className="col-md-6">
								...
								<div className="row">
									...
									<div className="col-md-4">
										<FormField
											label="Años de experiencia manejando"
									...
									<div className="col-md-12">
										<div className="mb-3">
											<label className="form-label">
												¿Tiene sistema de alarma o traba de seguridad?
											</label>
											<Field
												as="select"
												name="hasMotorcycleAntiTheft"
												className="form-select"
												id="hasMotorcycleAntiTheft">
										...
										<div className="row mt-3">
											<div className="col-md-12">
												<div className="mb-3">
													...
													<div className="row">
														{motorcycleInsurancePlans.map((plan) => (
...
export default MotorcycleInsuranceForm;
